...
function Surface () {
  var now = new Date();
  this.accent = "rgb(238, 17, 17)";
  this.nightAccent = "rgb(238, 0, 68)";
  this.nightStart = 18;
  this.fontWeight = 300;
  ...
  this.attach = function() {
    document.body.querySelector(".clock").appendChild(this.element);
...
$(function(){
    ...
    setTimeout(function() {
      document.body.scrollTop = document.body.querySelector(".clock").offsetTop;
    }, 5);


    setTimeout(function(){
      if(document.body.scrollTop >= document.body.querySelector(".clock").offsetTop) {
        showHelp();
